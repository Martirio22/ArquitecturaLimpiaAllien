...
public class MovimientoDetalleController {
    ...
    public ResponseEntity<MovimientoDetalleResponseDto> buscarPorId(@PathVariable Long idMovimientoDetalle) {
        var entidad = useCase.buscarPorId(idMovimientoDetalle);
